$(document).ready(function () {
    ...
    */
    ...
    navListItems.click(function (e) {
        ...
        if (!$item.hasClass('disabled')) {
            navListItems.removeClass('btn-pa-solid').addClass('btn-pa-solid');
            $item.addClass('btn-pa-solid').removeClass('btn-outline-dark');
    ...
    */
    ...
    $('div.setup-panel div a.btn-pa-solid').trigger('click');
